        ...
        return DB::transaction(
            function () use (
                ...
                $price = VariantPrice::query()
                    ->where(
                        'price_list_id',
                        $lockedConfiguration->price_list_id,
                    )
                    ->where(
                        'product_variant_id',
                        $variant->id,
                 ...
                 *
                 * Cancel the stock held for the old configuration
                 * before replacing any configuration item.
                 */
                $this->inventoryReservations
                    ->cancelActiveForConfiguration(
                        configuration: $lockedConfiguration,
                        reason: 'Configuration component changed.',
                    );
                ...
                $lockedConfiguration
                    ...
                    ->updateOrCreate(
                        ...
                        [
                            ...
                            'unit_price_in_cents' => $price->amount_in_cents,
